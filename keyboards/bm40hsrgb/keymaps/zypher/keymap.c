...
[_LAYER2] = LAYOUT_planck_mit(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_L, KC_PGDN, KC_PGUP, KC_MS_R, KC_NO, LALT_T(KC_NO), LCTL_T(KC_NO), LGUI_T(KC_GRV), LSFT_T(KC_BSLS), KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_TILD, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),

[_LAYER3] = LAYOUT_planck_mit(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, CG_SWAP, CG_NORM, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, LALT_T(KC_CAPS), LCTL_T(KC_NO), LGUI_T(KC_NO), RSFT_T(KC_NO), KC_NO, KC_NO, KC_NO, KC_NO, RSFT_T(KC_NO), RGUI_T(KC_NO), RCTL_T(KC_NO), RALT_T(KC_NO), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RESET, KC_NO, KC_NO, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO) 
