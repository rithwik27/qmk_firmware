...
//         sprintf(wpm_str, "WPM:%03d", get_current_wpm()/2);  // edit the string to change wwhat shows up, edit %03d to change how many digits show up
