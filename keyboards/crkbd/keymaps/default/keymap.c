...
enum custom_keycodes {
 ...
 [_LAYER0] = LAYOUT_split_3x6_3(KC_NO, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NO, KC_NO, LALT_T(KC_A), RCTL_T(KC_S), RGUI_T(KC_D), RSFT_T(KC_F), LT(1,KC_G), LT(1,KC_H), RSFT_T(KC_J), RGUI_T(KC_K), RCTL_T(KC_L), RALT_T(KC_QUOT), KC_LCTL, KC_LCTL, KC_LCTL, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_VOLD, KC_LGUI, LT(1,KC_TAB), KC_BSPC, KC_SPC, LT(2,KC_ENT), LT(3,KC_ESC)),
...
[_LAYER2] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_WH_L, KC_PGDN, KC_PGUP, KC_WH_R, KC_NO, KC_NO, KC_NO, RALT_T(KC_NO), RCTL_T(KC_NO), RGUI_T(KC_GRV), RSFT_T(KC_BSLS), KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_TILD, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO),
